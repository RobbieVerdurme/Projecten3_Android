package be.multinet.Utility

import android.view.View
import androidx.viewpager.widget.ViewPager
import be.multinet.adapter.ChallengeAdapter

class ShadowTransformer( private val mViewPager: ViewPager, private val mAdapter: ChallengeAdapter) : ViewPager.PageTransformer, ViewPager.OnPageChangeListener {
    ...
    override fun onPageScrolled(position: Int, positionOffset: Float, positionOffsetPixels: Int) {
        ...
        if (currentCard != null) {
            ...
            currentCard.cardElevation = baseElevation + (baseElevation
                    * (mAdapter.MAX_ELEVATION_FACTOR - 1) * (1 - realOffset))
        }
        ...
        if (nextCard != null) {
            ...
            nextCard.cardElevation = baseElevation + (baseElevation
                    * (mAdapter.MAX_ELEVATION_FACTOR - 1) * realOffset)
        }
